...
<body>
    <div class="container">
        ...
        <form action="/atm-succes" method="POST">
            @csrf
            ...
            <div class="container">
                ...
                <div class="row pt-4 justify-content-center">
                    <!-- <img class="botol"   alt=""> -->
                    <img type="image" class="botol" src="/image/botol.png">
                </div>


                <input type="hidden" id="user_id" class="form-control-plaintext" readonly name="user_id"
                    value="{{ auth()->user()->id }}" />
            ...
            <div class="row r-act-btn d-flex justify-content-between">
                <div class="col-6 act-btn kembali">
                    <div class="card">
                        <a href="{{ url('/atm-inputBotol') }}" class="btn btn-lg p-3"
                            style="color:white; background-color: #F52F53">Kembali</a>
                    </div>
                </div>
                <div class="col-6 act-btn selanjutnya">
                    <div class="card">
                        <button type="submit" id="saveJumlah" class="btn btn-lg p-3"
                            style="color:white; background-color: #28DF99">Selanjutnya</button>
                    </div>
                </div>
            </div>
        </form>
