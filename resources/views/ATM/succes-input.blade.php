    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <div class="row pt-4 r-checked justify-content-center">
                <img class="checked" src="/image/checked.png" alt="">
            </div>
            <div class="row pt-3">
        ...
        <div class="row r-act-btn d-flex justify-content-between">
            <div class="col-6 act-btn kembali">
                <div class="card">
                    <a href="{{ url('/atm-jumlahBotol') }}" class="btn btn-lg p-3"
                        style="color:white; background-color: #F52F53">Kembali</a>
                </div>
            </div>
            <div class="col-6 act-btn selanjutnya">
                <div class="card">
                    <a href="/atm-penghasilan/{{$updateSaldo->saldo}}" class="btn btn-lg p-3"
                        style="color:white; background-color: #28DF99">Selanjutnya</a>
                </div>
            </div>
        </div>
