        ...
        <div class="row pb-4">
            ...
            <div class="d-flex">
                <div class="col">
                    ...
                    <a href="merchant-totebag"><button class="btn-light btn-sm">Tote Bag</button></a>
                    <a href="merchant-pouchbag"><button class="btn btn-sm">Pouch Bag</button></a>
                </div>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col col-card mb-2">
                <div class="card a-card d-flex flex-column align-items-center mt-3" style="height: 22rem; width: 22rem">
                    <p class="mt-4" style="font-weight: bold; font-size: 22px; color: #343A40">PB Become Friendly</p>
                    <p style="font-size: 15px; color: #343A40">Rp 100.000</p>
                    <img src="image/pouchbag1.png" class="card-img-center" alt="">
                </div>
            </div>
