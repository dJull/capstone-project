...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="navbar d-flex bd-highlight mb-3 hidden fixed top-0 right-0 sm:block bg-white">
                    @auth
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="nav_col p-2 bd-highlight ml-4 text-sm">Tentang</a>
                        @endif
                    @endauth
                </div>
            @endif
